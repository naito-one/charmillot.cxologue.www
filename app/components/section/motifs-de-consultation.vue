<template>
  <app-section :section="section">
    <div class="flex flex-col md:flex-row justify-center">
      ...
      >
        <li
          class="py-6 px-10 mb-4 rounded-3xl shadow-md bg-c-red-3 flex flex-col items-center md:mr-4 lg:ml-16"
        >
        ...
        <li
          class="py-6 px-10 my-4 rounded-3xl shadow-md bg-c-violet-1 flex flex-col items-center md:mr-4"
        >
          <h3 class="font-bold text-xl text-center mb-1">
        ...
        <li
          class="py-6 px-10 mt-4 rounded-3xl shadow-md bg-c-red-3 flex flex-col items-center md:mr-4 lg:ml-10"
        >
          <h3 class="font-bold text-xl text-center mb-1">
      ...
      >
        <li
          class="py-6 px-10 mb-4 md:mb-0 md:mt-4 rounded-3xl shadow-md bg-c-violet-1 flex flex-col items-center md:ml-4 md:order-1"
        >
          <h3 class="font-bold text-xl text-center mb-1">
        ...
        <li
          class="py-6 px-10 mt-4 md:mt-0 md:mb-4 rounded-3xl shadow-md bg-c-red-3 flex flex-col items-center md:ml-4 lg:mr-16"
        >
          <h3 class="font-bold text-xl text-center mb-1">
